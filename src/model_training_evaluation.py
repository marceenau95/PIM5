...
import joblib
from src.ft_engineering import ft_engineering, NUMERIC_FEATURES, CATEGORICAL_FEATURES
from src.custom_transformers import DataFrameTransformer
...
def build_models():
    models = [
        ...
        ("CatBoost",CatBoostClassifier(iterations=500,auto_class_weights='Balanced',verbose=False, allow_writing_files=False))
...
# crear pipeline de limpieza, preprocesamiento y clasificación
inference_pipeline = Pipeline([
    ("cleaning", cleaning_pipeline),
    ("to_dataframe", DataFrameTransformer( NUMERIC_FEATURES + CATEGORICAL_FEATURES)
    ),
